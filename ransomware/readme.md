...
* **[OPCIONAL] Dificuldades encontradas:** [Descreva aqui se teve algum problema com o encode/decode de bytes ou na manipulação dos arquivos].
...
* **[OPCIONAL] Melhorias de Furtividade:** [Explique como o script foi estruturado para tentar não chamar a atenção do usuário durante a execução].
...
[Explique aqui como um EDR analisaria o comportamento do seu ransomware. Uma dica: foque na telemetria. Um processo Python abrindo dezenas de arquivos, injetando entropia alta (dados criptografados) e renomeando extensões em milissegundos gera um alerta crítico em plataformas modernas de EDR, permitindo isolar o host da rede antes que o dano se espalhe.]
